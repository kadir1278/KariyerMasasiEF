function addSwitcher()
{
	...
	//var demoPanel = '<div class="dz-demo-panel"><div class="bg-close"></div><a class="dz-demo-trigger" href="javascript:void(0)"><span><i class="las la-tint"></i></span></a><div class="dz-demo-inner"><a href="javascript:void(0);" class="btn btn-primary btn-sm px-2 py-1 mb-3" onclick="deleteAllCookie()">Delete All Cookie</a><div class="dz-demo-header"><h4>Select A Demo</h4><a class="dz-demo-close" href="javascript:void(0)"><span><i class="las la-times"></i></span></a></div><div class="dz-demo-content"><div class="dz-wrapper"><div class="overlay-bx rounded-lg dz-demo-bx demo-active"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic1.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="1" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="1" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 1</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic5.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="5" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="5" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 2</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic4.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="4" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="4" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 3</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic2.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="2" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="2" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 4</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic3.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="3" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="3" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 5</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic6.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="6" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="6" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 6</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic7.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="7" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="7" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 7</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic8.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="8" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="8" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 8</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic9.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="9" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="9" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 9</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic10.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="10" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="10" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 10</h5><hr><div class="overlay-bx rounded-lg dz-demo-bx"><div class="overlay-wrapper rounded-lg"><img src="/Content/images/demo/pic11.jpg" alt="" class="w-100"></div><div class="overlay-layer"><a href="javascript:void(0);" data-theme="11" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Default</a><a href="javascript:void(0);" data-theme="11" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL Version</a></div></div><h5 class="text-black">Demo 11</h5></div></div></div></div>';
...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "/Content/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "/Content/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "/Content/images/logo-text.png");
			
			setCookie('logo_src', '/Content/images/logo.png');
			setCookie('logo_src2', '/Content/images/logo-text.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "/Content/images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "/Content/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "/Content/images/logo-text-white.png");
			
			setCookie('logo_src', '/Content/images/logo-white.png');
			setCookie('logo_src2', '/Content/images/logo-text-white.png');
		}
